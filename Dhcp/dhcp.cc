// ./waf --run scratch/dhcp
// tcpdump -nn -tt -r dhcp-csma-0-0.pcap
// sudo apt install wireshark(if wireshark is not installed,otherwise skip this command)
// wireshark -r dhcp-csma-0-0.pcap
